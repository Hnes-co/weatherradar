import { handlePercipitation } from "../services/percipitation";
  ...
  return (
    <div className="city-grid-item">
      <div className="grid-item-main">
        <div className="grid-item-main-top">
        ...
        <div className="grid-item-main-bottom">
      ...
      <div className="grid-item-hourly-list">
